    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="w-64 bg-emerald-600 text-white">
                <div className="p-4 flex items-center gap-2 text-xl font-bold">
                    <DollarSign size={24} />
                    <span>TBD</span>
                </div>

                <nav className="mt-6">
                    <Link to="/dashboard" className="flex items-center gap-3 bg-emerald-500 px-4 py-3 font-medium">
                        <Home size={20} />
                        <span>Dashboard</span>
                    </Link>

                    <Link to="/transactions" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 transition-colors">
                        <Bolt size={20} />
                        <span>Transactions</span>
                    </Link>

                    <Link to="/budget" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 transition-colors">
                        <User size={20} />
                        <span>Budgets</span>
                    </Link>

                    <Link to="/assets" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 transition-colors">
                        <DollarSign size={20} />
                        <span>Assets</span>
                    </Link>

                    <Link to="/calendar" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 transition-colors">
                        <Calendar size={20} />
                        <span>Calendar</span>
                    </Link>

                    <Link to="/tax" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 transition-colors">
                        <User size={20} />
                        <span>Zakat & Tax</span>
                    </Link>

                    <Link to="/chatbot" className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-700 transition-colors">
                ...
                <div className="absolute bottom-0 w-64 p-4 border-t border-emerald-700">
                    ...
                    <div className="text-xs text-emerald-200 mt-1">samwheeler@example.com</div>
                </div>
            </div>
                ...
                {emptyState ? (
                    <div className="bg-white rounded-lg shadow p-8 text-center">
                        ...
                        <div className="flex justify-center gap-4">
                            <Link to="/transactions" className="bg-emerald-600 text-white px-4 py-2 rounded hover:bg-emerald-700">
                                Add Transaction
                            </Link>
                            <Link to="/budget" className="bg-emerald-600 text-white px-4 py-2 rounded hover:bg-emerald-700">
                                Set Budget
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        {/* Net Cash */}
                        <div className="bg-teal-800 text-white p-6 rounded-lg shadow">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow">
                                ...
                                <div className="space-y-4">
                                    {dashboardData.recentTransactions.map((transaction, index) => (
                                        <div key={transaction.transaction_id} className="flex items-center justify-between">
                                            ...
                                            <div
                                                className={`font-medium flex items-center ${transaction.transaction_type === "credit" ? "text-green-600" : "text-red-600"
                                                    }`}
                                            >
                            ...
                            <div className="mt-6 text-right">
                                <Link
                                    to="/transactions"
                                    className="text-emerald-600 hover:text-emerald-800 flex items-center justify-end"
                                >
                        ...
                        <div className="bg-white p-6 rounded-lg shadow lg:col-span-2">
                            ...
                            <div className="mt-6 text-right">
                                <Link to="/budget" className="text-emerald-600 hover:text-emerald-800 flex items-center justify-end">
